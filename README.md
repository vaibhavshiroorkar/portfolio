...
-   **Clean & Modern UI**: A polished light theme with subtle silver accents and glass effects.
-   **Responsive Design**: It looks great whether you're viewing it on a giant desktop monitor or your phone on the go.
...
-   **HTML5** for structure
-   **CSS3** for styling (CSS Variables, Flexbox, & Grid)
...
1.  **Clone the repo:**
    ```bash
    git clone https://github.com/vaibhavshiroorkar/portfolio.git
    cd portfolio
    ```

2.  **Open it up:**
    -   You can just double-click `index.html` to open it in your browser.
    -   Or, if you prefer a local server (recommended for smoother navigation):
        ```bash
...
-   **Colors**: Just pop into `index.css` and tweak the variables at the top (`:root`).
